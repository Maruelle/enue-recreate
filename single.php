...
<main>
  <section class="BlogPage_Banner">
    <h1 class="BlogPage_Banner__title">Blog</h1>
    <h3 class="BlogPage_Banner__subtitle">施工・実績BLOG</h3>
  </section>
  <section class="Single_section_1">
    <div class="container">
      <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
          ...
          <div class="img_container">
            <?php the_post_thumbnail('medium-large', array('class' => 'img_container')); ?>
          </div>
          <p class="desc">
            <?php the_content(); ?>
          </p>
