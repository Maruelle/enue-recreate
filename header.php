...
<head>
    ...
    <title>NA</title>
    <link rel="shortcut icon" type="image/jpg" href="<?php echo get_template_directory_uri(); ?>/assets/img/NA.png">
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/flow.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/company_info.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/recruitment.css">
